                    ...
                    <div className="relative h-[600px]">
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center gap-2 text-[10px] text-ink-lighter uppercase tracking-[0.18em]">
                                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-400" />
                                    <span>Repurposed from blog</span>
                                </div>
                                <p className="text-[13px] leading-relaxed text-ink-light">
                                    7 ways to turn one long‑form article into a month of LinkedIn content.
                                </p>
                                <div className="flex items-center justify-between text-[11px] text-ink-lighter pt-1">
                                    <span>Save • Comment • Share</span>
                                    <span className="font-medium text-ink-light">+34% reach</span>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="space-y-2 text-[12px] text-ink-light">
                                <p>1/6 • The fastest way to repurpose one blog into a full Twitter thread 👇</p>
                                <p className="text-ink-lighter">@you • 2m ago · 12 likes</p>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="flex items-center gap-3 mb-3">
                                <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[hsl(var(--accent))/0.2] to-emerald-400/20 flex items-center justify-center">
                            ...
                            <div className="aspect-[4/5] rounded-xl overflow-hidden bg-gradient-to-br from-accent/25 via-purple-500/20 to-pink-500/25 relative">
                                {/* Soft frame */}
                                <div className="absolute inset-3 rounded-[22px] border border-white/25/">
                                </div>
                                {/* Text overlay */}
                                <div className="absolute inset-5 flex flex-col justify-end space-y-1 text-[11px] leading-relaxed text-white">
                                    <p className="font-semibold drop-shadow-md">
                                        Carousel hook
                                    </p>
                                    <p className="drop-shadow-sm">
                                        “Stop writing from scratch for every platform.”
                                    </p>
                                    <p className="text-white/75 drop-shadow-sm pt-1">
                                        Slide 1 of 7 • Designed automatically.
                                    </p>
                                </div>
                            </div>
                        </motion.div>
